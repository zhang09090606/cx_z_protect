 ...
 * Generated at: 2019-01-21 12:50:28 UTC
...
public final class peo_005fresiger_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-body \" style=\"padding-left: 25px;\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"row\" >\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-12 d-flex\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"numbers \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">&nbsp;&nbsp;请填写您要注册的驾驶员信息</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"container-fluid\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--表单开始-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form role=\"form\" style=\"width: 120%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"name\">姓名:</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"pname\" id=\"pname\" placeholder=\"请输入驾驶员姓名\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"card\">身份证号码:</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" name=\"pcard\" id=\"card\" placeholder=\"请输入驾驶员身份证号码\"style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</br>\r\n");
