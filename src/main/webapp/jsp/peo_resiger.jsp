						...
						<div class="card-body " style="padding-left: 25px;" >
							<div class="row" >
								...
								<div class="col-12 d-flex" >
									<div class="numbers ">
										<h4 class="card-title">&nbsp;&nbsp;请填写您要注册的驾驶员信息</h4>
										</br>
										<div class="container-fluid" >
											<div class="row" >
												<!--表单开始-->
												<form role="form" style="width: 120%;">
													<div class="form-group" style="width: 100%;">
														<label for="name">姓名:</label>
														<input type="text" class="form-control" name="pname" id="pname" placeholder="请输入驾驶员姓名" style="width: 100%">
													</div>
													<div class="form-group" style="width: 100%;">
														<label for="card">身份证号码:</label>
														<input type="text" class="form-control " name="pcard" id="card" placeholder="请输入驾驶员身份证号码"style="width: 100%;">
													</div>
													</br>
