			...
			<div class="container-fluid">
				...
				<form class="navbar-left navbar-form nav-search mr-md-3" action="">
					<div class="input-group">
						<input class="form-control" type="text" placeholder="车辆搜索">
								...
								<div class="col-12 d-flex align-items-center">
									<div class="numbers text-center">
										...
										<div style="float:left;margin-left: 20px;margin-top: 10px;">
											...
											<p>车辆名称:雷克萨斯 </p>
											<p>车牌号	:XXXXXXX</p>
											<button id="fat-btn" class="btn btn-success" data-loading-text="Loading..."type="button"> 启用车辆
											</button>
											<button class="btn btn-large btn-default" type="button">删除车辆信息</button>
